...
It consists of seven steps to be executed in sequence:
...
NOTE: The operations of this step can be executed at once using the `scripts/5_delete_restore_pods.sh` script.
...
NOTE: The operations of this step can be executed at once using the `scripts/6_schedule.sh` script.
...
NOTE: The operations of this step can be executed at once using the `scripts/7_stop.sh` script.
