...
NOTE: If you prefer to use https://k3s.io/[k3s] instead of Minikube, just switch to the https://github.com/vshn/k8up-tutorial/tree/k3d[k3d branch] in the tutorial repository. There's also a version for https://github.com/vshn/k8up-tutorial/tree/openshift[Red Hat OpenShift]!
